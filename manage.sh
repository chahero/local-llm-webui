...
# Local LLM WebUI Management Script
# Usage: ./manage.sh [start|stop|restart|status|logs|install|setup]
...
help() {
    cat << EOF
${BLUE}Local LLM WebUI Management Script${NC}
